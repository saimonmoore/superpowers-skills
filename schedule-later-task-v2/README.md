...
```bash
skill_root="/Users/saimon.moore/Development/AI/superpowers-skills/schedule-later-task-v2"
...
python3 "$skill_root/scripts/schedule_task.py" \
  ...
  --mail-marker-prefix schedule-later-task-v2 \
  --json
```

`--mail-marker-prefix` is optional and defaults to `schedule-later-task-v2`.
...
```json
{
  ...
  "assumptions": [],
  "errors": [],
  "mail_marker_prefix": "schedule-later-task-v2",
